<footer style="background:#1a2d22; color:rgba(255,255,255,0.7); font-family:'DM Sans',sans-serif; margin-top:auto;">
    <div style="max-width:1100px; margin:0 auto; padding:32px 24px 20px;">
        ...
        <div style="display:grid; grid-template-columns:1.2fr 1fr 1fr; gap:32px; margin-bottom:24px;">
            ...
            {{-- Liens rapides --}}
            <div>
                <div style="font-size:10px; letter-spacing:0.12em; text-transform:uppercase; color:#8FCBA5; margin-bottom:12px; font-weight:600;">A Propos</div>
                <div style="display:flex; flex-direction:column; gap:8px;">
                    ...
                    <a href="/ActualitesAdmi" style="font-size:12px; color:rgba(255,255,255,0.6); text-decoration:none; transition:color .2s;">Actualités</a>
                    <a href="/StatistiquesAdmi" style="font-size:12px; color:rgba(255,255,255,0.6); text-decoration:none; transition:color .2s;">Statistiques</a>
                    <a href="/Donnees" style="font-size:12px; color:rgba(255,255,255,0.6); text-decoration:none; transition:color .2s;">Données</a>
                    <a href="/UtilisateursAdmi" style="font-size:12px; color:rgba(255,255,255,0.6); text-decoration:none; transition:color .2s;">Utilisateurs</a>
                </div>
            </div>
